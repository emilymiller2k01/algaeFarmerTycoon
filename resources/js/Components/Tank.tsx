...
//there just isnt a progress in the props 
...
const Tank = (props) => {
    ...
    return (
        <div className="relative">
            <div className="absolute top-[15px] left-0 p-2 flex flex-col justify-end h-[120px] w-[200px] gap-2">
                <div className="h-full w-full rounded-full border overflow-hidden bg-grey-light border-green-dark text-green flex items-center justify-center">
                    <div className="h-[17px] bg-green-dark" style={{ width: `${progress}%` }}>
                        Biomass
                    </div>
                </div>
                <div className="h-full w-full rounded-full border overflow-hidden bg-grey-light border-green-dark text-green flex items-center justify-center">
                    <div className="h-[17px] bg-yellow" style={{ width: `${progress}%` }}>
                        Nutrients
                    </div>
                </div>
                <div className="h-full w-full rounded-full border overflow-hidden bg-grey-light border-green-dark text-green flex items-center justify-center">
                    <div className="h-[17px] bg-orange" style={{ width: `${progress}%`, padding: '0 5px' }}>
                        CO2
                    </div>
                </div>
            </div>
